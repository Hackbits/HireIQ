      ...
      <div className="card max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: "var(--on-surface-variant)" }}>
            Start screening resumes with AI for free
          </p>
        </div>
        ...
        <form onSubmit={handleEmailSignup} className="space-y-4">
          ...
          <div>
            <label className="form-label block mb-1.5">Organization / Company Name</label>
            <input
              type="text"
              required
              className="input-field w-full"
          ...
          <div>
            <label className="form-label block mb-1.5">Organization Size</label>
            <select
              required
              className="input-field w-full bg-[#030712] text-white"
          ...
          <div>
            <label className="form-label block mb-1.5">Work Email</label>
            <input
              type="email"
              required
              className="input-field w-full"
